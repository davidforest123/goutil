...
// Fork from https://github.com/libp2p/go-reuseport
//
...
// ReuseListen listens at the given network and address. see net.Listen
...
// ReuseListenPacket listens at the given network and address. see net.ListenPacket
// Returns a net.Listener created from a file discriptor for a socket
// with SO_REUSEPORT and SO_REUSEADDR option set.
...
// ReuseDial dials the given network and address. see net.Dial
// Returns a net.Conn created from a file descriptor for a socket
// with SO_REUSEPORT and SO_REUSEADDR option set.
func ReuseDial(network, laddr, raddr string) (net.Conn, error) {
	return ReuseDialTimeout(network, laddr, raddr, time.Duration(0))
}

// ReuseDialTimeout dials the given network and address, with the given timeout. see
