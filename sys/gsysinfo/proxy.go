...
and, pac/http proxy operations using system api (but not command) works too, sample project https://github.com/getlantern/pac-cmd,https://github.com/getlantern/sysproxy-cmd
