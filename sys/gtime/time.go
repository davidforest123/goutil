...
// EqualUnixNano returns `a`.UnixNano() equals `b`.UnixNano()
// time.Time{}.Equal() will check if timezone pointer equals, but EqualUnixNano doesn't check.
func EqualUnixNano(a, b time.Time) bool {
